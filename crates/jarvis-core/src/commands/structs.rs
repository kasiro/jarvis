...
pub struct JCommandsList {
    ...
    #[serde(alias = "list", default)]
    pub commands: Vec<JCommand>,
}

// Legacy YAML format structures
#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct LegacyCommand {
    pub command: LegacyCommandData,
    #[serde(default)]
    pub voice: Option<LegacyVoice>,
    #[serde(default)]
...
// Unified command structure supporting both TOML and YAML formats
// Legacy YAML format is converted to JCommand in parse_commands()
...
pub struct JCommand {
    ...
    #[serde(rename = "type", alias = "action", default)]
    pub cmd_type: String,
    ...
    // CACHE
    #[serde(skip, default)]
    pub sounds_cache: RwLock<HashMap<String, Arc<Vec<String>>>>,

    #[serde(skip, default)]
    pub phrases_cache: RwLock<HashMap<String, Arc<Vec<String>>>>,
}

impl Default for JCommand {
    fn default() -> Self {
        Self {
            id: String::new(),
            cmd_type: String::new(),
